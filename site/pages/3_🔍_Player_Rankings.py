...
with tabs[1]:
    ...
    if go_deeper:
        ...
        player_years = player_years.groupby('PLAYER_NAME')['YEAR'].count().reset_index()
        player_years = player_years.rename(columns={'YEAR': 'YEARS_IN_LEAGUE'})
        ...
        if all_time:
            ...
            if check_years:
                # max years in league
                years_in_league = st.slider('Number of years in league', 0, max_years, 5)
