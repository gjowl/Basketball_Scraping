...
for per_mode in per_mode_list:
    for season_id in season_id_list:
        player_file = f"{output_dir}_{per_mode}_{season_id}.csv"
        column_names_file = f"{output_dir}_{per_mode}_{season_id}.csv"
        all_data_file = f"{output_dir}_{per_mode}_{season_id}.csv"
        wait()
